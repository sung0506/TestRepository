...
function ipgoUpdate(){
	location.href="goodsIpgoUpdate.ipgo?ipgoNum=${dto.goodsIpgoNum }&num=${dto.goodsNum }";
}
function ipgoDelte(){
	location.href="goodsIpgoDelete.ipgo?ipgoNum=${dto.goodsIpgoNum }&num=${dto.goodsNum }";
}
</script>
</head>
<body>
