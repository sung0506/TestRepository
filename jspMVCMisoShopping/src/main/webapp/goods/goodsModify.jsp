...
<table border=1 align="center" width="600">
	...
	<tr><th>등록일</th>
		<td><input type="text" name="goodsRegist" value="${dto.goodsRegist }"></td></tr>
	<tr><th>마지막 수정 사원</th>
		<td><input type="text" name="updateEmpNum" value=""></td></tr>
	<tr><th>마지막 수정일</th>
		<td><input type="text" name="goodsUpdateDate" value=""></td></tr>
	<tr><th colspan="2">
